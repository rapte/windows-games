...
outtextxy(320,375,"horizontal");
    ...
    if((mx1>=100)&&(mx1<=200)&&(my1>=340)&&(my1<=400))
      {vorh='v';}
         ...
         {vorh='h';}
         else {print();outtextxy(35,320,"Click inside the box!!");
  ...
  while (!ismouseclick(WM_LBUTTONDOWN))
    ...
    sndPlaySound("tump.wav", SND_ASYNC);
      ...
      if ((mx1 <=7)&&(my1 <=9))
        ...
        switch(temp)
         {
         case 1:sndPlaySound("land_1.wav", SND_ASYNC);
         break;
         case 2:sndPlaySound("land_2.wav", SND_ASYNC);
         break;
         case 3:sndPlaySound("land_3.wav", SND_ASYNC);
         break;
         }
         delay(2000);
           }else {print();outtextxy(35,320, "That spot is already taken by another spaceship");sndPlaySound("spin.wav", SND_ASYNC);delay(2000);}

       }else {print();outtextxy(35,320, "That is outside the bounderies of the grid");sndPlaySound("spin.wav", SND_ASYNC);delay(2000);}
 }
...
for(int i=5; i>=1;i=i-1)
 ...
 cleardevice();
  ...
  switch(i)
  {
  case 1: outtextxy(240,250,"1");break;
  case 2: outtextxy(240,250,"2");break;
  case 3: outtextxy(240,250,"3");break;
  case 4: outtextxy(240,250,"4");break;
  case 5: outtextxy(240,250,"5");break;
  }
...
if((mx>=10)||(mx<0)||(my>=10)||(my<0))
 {print();outtextxy(35,320, "That is outside the computers grid!");sndPlaySound("spin.wav", SND_ASYNC);delay(2000); ha=1;}
else if ((visual_c[my][mx]== -1)||(visual_c[my][mx]==-2))
 {print();outtextxy(35,320, "You already choose that target before");sndPlaySound("spin.wav", SND_ASYNC);delay(2000);ha=1;}
 }while(ha==1);
  if (visual_c[my][mx]==0)
   {
   print();
   ...
   switch(temp2)
     {
    case 1:sndPlaySound("room.wav", SND_ASYNC);
      break;
    case 2:sndPlaySound("woop.wav", SND_ASYNC);
      break;
      } delay(2000);
    visual_c[my][mx]=-1;}
  else
   ...
   sndPlaySound("fire_2.wav", SND_ASYNC);delay(3000);
   destroy_c(mx,my); visual_c[my][mx]=-2; }
   a();
 }
//******************************************************************************
...
// cout << "***case:0 x and y "<< x << " " << y<< endl;
 ...
 case 1:
  ...
  {do{
   if (ai[3]>10)
  {ai[3]=0;ai[2]=0;ai[1]=1;what=1;break;}
   if (ai_x1==ai_x2)
     {x=ai_x1;}
     else if (ai_x1 < ai_x2)
      do{
       temp1=randomize(2,1);
       switch(temp1)
        {case 1:x=ai_x1-1;break;
        case 2:x=ai_x2+1;break;}
         }while ((x<0)||(x>=10));
       else
         do
          {temp1=randomize(2,1);
    ...
    if (ai_y1==ai_y2)
     {y=ai_y1;}
      ...
      do{
        temp1=randomize(2,1);
        switch(temp1)
        {case 1:y=ai_y1-1;break;
         case 2:y=ai_y2+1;break;}
         }while ((y<0)||(y>=10));
       else
         do
          {
